        ...
        >
            ...
            <View className="relative">
                <View className="items-center mt-10">
                    <View className="relative">
                        <View className="rounded-full border-2 border-primary-dark">
                            <Image
                        ...
                        <Pressable className="absolute bottom-1 right-1 w-8 h-8 bg-primary rounded-full items-center justify-center border-2 border-primary-dark">
                            <Ionicons name="camera" size={16} color="#E76F51" />
                        </Pressable>
                    </View>
